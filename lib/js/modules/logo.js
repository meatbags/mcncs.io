...
class Logo {
  constructor(scene) {
    ...
    this.components = {
      ...
      joinAB: new THREE.Mesh(new THREE.BoxBufferGeometry(1, 4, 1), Config.material.depth),
      joinBC: new THREE.Mesh(new THREE.BoxBufferGeometry(1, 4, 1), Config.material.depth),
    };
