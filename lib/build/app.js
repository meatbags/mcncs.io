...
var Master = function () {
  ...
  _createClass(Master, [{
    ...
    value: function init() {
      ...
      this.block = new THREE.Mesh(new THREE.BoxBufferGeometry(1, 10, 1), this.material);
...
THREE.MechanicsShader = {
  ...
  vertexShader: '\n    varying vec2 vUv;\n\n    void main() {\n      vUv = uv;\n      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n    }\n  ',
  fragmentShader: '\n    varying vec2 vUv;\n    uniform sampler2D tDiffuse;\n    uniform float time;\n\n    void main() {\n      vec4 tex = texture2D(tDiffuse, vUv);\n      float offset = sin(time / 2.0) * 0.01;\n      vec4 samp = texture2D(tDiffuse, vec2(vUv.x - offset, vUv.y));\n\n      float r = (tex.r + samp.r) / 2.0;\n      float g = tex.g;\n      float b = tex.b;\n\n      gl_FragColor = vec4(r, g, b, 1.0);\n    }\n  '
};
